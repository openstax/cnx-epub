...
{% endif %}
{% if data['items'].0.required_context %}
    <div data-type="req-context" data-context-module="{{ data['items'].0.required_context.module }}" data-context-feature="{{ data['items'].0.required_context.feature }}">
        <a class="autogenerated-content" href="#{{ data['items'].0.required_context.ref }}">[link]</a>
    </div>
{% endif %}
