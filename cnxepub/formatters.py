            ...
            if tags and any('context-cnxfeature' in tag for tag in tags):
                ...
                for tag in tags:
                    ...
                    if 'context-cnxfeature:' in tag:
                        feature = tag.split(':')[1]
                exercise['items'][0]['required_context'] = "auto_%s_%s" %(module, feature)
...
{% if data['items'].0.required_context %}
    <span class="req-context"><a class="autogenerated-content" href="#{{ data['items'].0.required_context }}">[link]</a></span>
{% endif %}
