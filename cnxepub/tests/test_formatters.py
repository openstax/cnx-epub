...
<div>
    <div data-type="page" id="page_uuid1">
        <div id="auto_uuid1_autodetect-feature"></div>
        <div data-type="req-context" data-context-module="uuid1" data-context-feature="feature-1">
...
<div>
    <div data-type="page" id="page_uuid1">
        <div id="auto_uuid1_autodetect-feature"></div>
        <div data-type="req-context" data-context-module="uuid2" data-context-feature="feature-1">
            <a class="autogenerated-content" href="#auto_uuid2_feature-1">[link]</a>
        </div>
    </div>
</div>"""
        self.assertEqual(xmlpp(expected_content.encode('utf-8')).split(b'\n'),
...
<div>
    ...
    def test_annotate_autdetectparent(self, requests_get):
        ...
        get_resp.json.return_value = {
            ...
            'items': [{
                'tags': [
                    "context-cnxfeature:autodetect-feature",
                    "context-cnxmod:uuid2"
                ]
            }]
        }
...
<div>
    <div data-type="page" id="page_uuid1">
        <div id="auto_uuid1_autodetect-feature"></div>
        <div data-type="req-context" data-context-module="uuid1" data-context-feature="autodetect-feature">
            <a class="autogenerated-content" href="#auto_uuid1_autodetect-feature">[link]</a>
        </div>
    </div>
</div>"""
        self.assertEqual(xmlpp(expected_content.encode('utf-8')).split(b'\n'),
