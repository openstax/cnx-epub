...
<div>
    <div data-type="page" id="page_uuid1">
        <div id="auto_uuid1_feature-1"></div>
        <div data-type="req-context" data-context-module="uuid2" data-context-feature="feature-donotexist">
            <a class="autogenerated-content" href="#auto_uuid2_feature-donotexist">[link]</a>
        </div>
    </div>
</div>"""
        self.assertEqual(xmlpp(expected_content.encode('utf-8')).split(b'\n'),
