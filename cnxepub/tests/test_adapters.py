...
class ModelsToEPUBTestCase(unittest.TestCase):
    ...
    def test_loose_pages_wo_resources(self):
        ...
        self.assertEqual([opf_filename, 'contents', 'META-INF', 'mimetype'],
                         os.listdir(epub_path))
        self.assertEqual([navdoc_filename, 'egress.xhtml', 'ingress.xhtml'],
                         os.listdir(os.path.join(epub_path, 'contents')))
    ...
    def test_binder(self):
        ...
        # Check filenames, generated by id and media-type.
        self.assertEqual(['contents', 'META-INF', 'mimetype', opf_filename],
                         os.listdir(epub_path))
        self.assertEqual(['egress.xhtml', 'ingress.xhtml', navdoc_filename],
                         os.listdir(os.path.join(epub_path, 'contents')))
